...
def sms_reply():
    ...
    if(msg=='Birimler'):
        ...
        for key,value in result['rates'].items():
            string_result = string_result + (key+ ' --> ' + exchange.get(key) + '-->' + str(value)) +'\n'
